...
Route::Get('ds-user', 'ShopHoaController@getDsUSER');// View danh sach USER
Route::Get('them-user', 'ShopHoaController@getThemUser');// Them 1 User moi
Route::Get('xoa-user/{id}', 'ShopHoaController@getXoaUser');// Xoa 1 user voi ID
Route::Get('sua-user', 'ShopHoaController@getTrangSuaUser');

Route::Post('dang-nhap-tai-khoan', ['as' => 'postDangNhap', 'uses' =>'ShopHoaController@checkDangNhap']);//Dang nhap vao tai khoan, gui email va password de kiem tra
Route::Post('them-user-moi', ['as' => 'postThemUser', 'uses' => 'ShopHoaController@postThemUser']);

Route::Post('chinh-sua-thong-tin', ['as' => 'postSuaThongTinUser', 'uses' => 'ShopHoaController@postSuaUser']);
